<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <p class="text-xs font-bold uppercase tracking-[.15em] text-sky-500 mb-1">Master Admin · User Management · Guru</p>
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-3 justify-center sm:justify-start">
                            ...
                            @endif
                            <span class="px-3 py-1 rounded-xl text-xs font-medium text-sky-400" style="background:rgba(240,249,255,.6)">{{ $teacher->created_at->format('d M Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="gc fi2 rounded-3xl p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="info-row">
                                ...
                                @if($teacher->user->school->name ?? null)
                                    <span class="info-val">{{ $teacher->user->school->name }}</span>
                                @else
                            ...
                            <div class="info-row">
                                ...
                                @if($teacher->user->school->npsn ?? null)
                                    <span class="info-val">{{ $teacher->user->school->npsn }}</span>
                                @else
                                    <span class="info-val-empty">Tidak tersedia</span>
                                @endif
                            </div>
                    ...
                    <div class="gc fi2 rounded-3xl p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-val">{{ $teacher->created_at->format('d M Y') }}</span>
                            </div>
                            @if($teacher->nip)
                            <div class="info-row">
                                <span class="info-label">NIP</span>

<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <p class="text-xs font-bold uppercase tracking-[.15em] text-sky-500 mb-1">Master Admin · User Management · Siswa</p>
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-3 justify-center sm:justify-start">
                            ...
                            @endif
                            <span class="px-3 py-1 rounded-xl text-xs font-medium text-sky-400" style="background:rgba(240,249,255,.6)">{{ $student->created_at->format('d M Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="gc fi2 rounded-3xl p-6">
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider">Informasi Sekolah</h3>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="info-row">
                                <span class="info-label">Nama Sekolah</span>
                                @if($student->user->school->name ?? null)
                                    <span class="info-val">{{ $student->user->school->name }}</span>
                                @else
                                    <span class="info-val-empty">Tidak tersedia</span>
                                @endif
                            </div>
                            <div class="info-row">
                                <span class="info-label">NPSN</span>
                                @if($student->user->school->npsn ?? null)
                                    <span class="info-val">{{ $student->user->school->npsn }}</span>
                                @else
                                    <span class="info-val-empty">Tidak tersedia</span>
                                @endif
                            </div>
                    ...
                    <div class="gc fi2 rounded-3xl p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-val">{{ $student->created_at->format('d M Y') }}</span>
                            </div>
                            @if($student->nisn)
                            <div class="info-row">
                                <span class="info-label">NISN</span>

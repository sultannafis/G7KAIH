                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                           class="sky-input" placeholder="Contoh: SMA Negeri 1 Jakarta" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                                    @error('name')<p class="field-error">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label class="sky-label">NPSN *</label>
                                    <input type="text" id="npsn" name="npsn" value="{{ old('npsn') }}" required
                                           class="sky-input" placeholder="Nomor Pokok Sekolah Nasional" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" id="admin_password" name="admin_password" required
                                               class="sky-input pr-10" placeholder="Min. 8 karakter">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" id="admin_password_confirmation" name="admin_password_confirmation" required
                                               class="sky-input pr-10" placeholder="Ulangi password">

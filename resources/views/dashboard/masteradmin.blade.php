                        ...
                        <div class="grid grid-cols-3 gap-3">
                            @php
                                $actions = [
                                    ...
                                    ['route' => route('user-management.teachers.index'), 'label'=>'Guru','color'=>'from-violet-400 to-violet-600', 'shadow'=>'rgba(124,58,237,.3)',   'icon'=>'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z'],
                                    ['route' => route('user-management.students.index'),'label'=>'Siswa','color'=>'from-sky-300 to-sky-500',       'shadow'=>'rgba(14,165,233,.3)',   'icon'=>'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
                                    ['route' => route('user-management.parents.index'),'label'=>'Ortu',  'color'=>'from-rose-400 to-rose-600',     'shadow'=>'rgba(244,63,94,.3)',    'icon'=>'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],

            ...
            <div class="grid grid-cols-1 xl:grid-cols-5 gap-5">
                ...
                <div class="xl:col-span-3 gc sec-1 rounded-3xl p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        @php
                        $quickActions = [
                            ['href' => route('school-admin.user-management.teachers.index'), 'label' => 'Tambah Guru', 'desc' => 'Kelola data guru sekolah', 'color' => 'icon-sky',    'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z'],
                            ['href' => route('school-admin.user-management.students.index'), 'label' => 'Kelola Siswa', 'desc' => 'Manajemen data siswa',   'color' => 'icon-green',  'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
                            ['href' => route('school-admin.user-management.parents.index'),  'label' => 'Orang Tua',   'desc' => 'Data orang tua siswa',  'color' => 'icon-violet', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],

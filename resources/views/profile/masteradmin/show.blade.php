<x-app-layout>
    <x-slot name="header">
        ...
        <p class="text-slate-500 font-medium mt-1 text-sm">Kelola informasi pribadi dan keamanan profil Master Admin</p>
    </x-slot>
    ...
    @include('profile._partials.layout', [
        ...
        'slot' => view('profile.masteradmin._settings_content', ['user' => $user])
    ])
</x-app-layout>

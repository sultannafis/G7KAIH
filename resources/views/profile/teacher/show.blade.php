<x-app-layout>
    <x-slot name="header">
        ...
        <p class="text-slate-500 font-medium mt-1 text-sm">Kelola informasi pribadi dan keamanan profil Guru Anda</p>
    </x-slot>

    @include('profile._partials.layout', [
        'sidebar' => view('profile._partials.sidebar-info', [
            'user' => $user,
            'roleName' => 'Guru Pengampu',
            'gradient' => 'from-sky-400 to-indigo-600',
            'badgeClass' => 'bg-sky-50 text-sky-600 border-sky-100'
        ]),
        'slot' => view('profile.teacher._settings_content', ['user' => $user])
    ])
</x-app-layout>
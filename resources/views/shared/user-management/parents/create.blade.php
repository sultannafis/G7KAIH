<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            /* Elevate the card containing the open dropdown above its siblings */
            /* Also remove backdrop-filter when active — it creates a stacking context that clips z-index */
            ...
            .csd-trigger.open, .csd-trigger:focus {
                border-color:#38bdf8;
            ...
            .csd-list {
                overflow-y:auto;
                max-height:calc(5 * 38px); /* exactly 5 items */
                padding:4px;
            }
            /* Custom scrollbar */
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 style="font-size:1.35rem;font-weight:800;color:#0c4a6e;letter-spacing:-0.01em;">Tambah Orang Tua</h2>
                <p style="font-size:.82rem;color:#0369a1;margin-top:2px;">Tambah data orang tua/wali siswa baru ke sistem</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('user-management.parents.index') }}" class="btn-ghost">
    ...
    <div style="padding:1.5rem 0;">
        <div style="max-width:1600px;margin:0 auto;padding:0 1rem;" class="sm:px-6 lg:px-8 xl:px-12">
            ...
            @endif
            <form method="POST" action="{{ route('user-management.parents.store') }}">
                @csrf
                <div style="display:grid;grid-template-columns:1fr;gap:1.25rem;" class="xl:grid-two">
                    <style>.xl-grid-two { display:grid;grid-template-columns:repeat(2,1fr);gap:1.25rem; } @media(min-width:1280px){.xl-grid-two{display:grid;grid-template-columns:repeat(2,1fr);}}</style>

                    <div style="display:grid;gap:1.25rem;" class="xl:contents">
                    ...
                    <div class="gc form-anim" style="padding:1.5rem;">
                        ...
                        <div style="display:grid;grid-template-columns:1fr;gap:1rem;" class="md:grid-two">
                            <style>@media(min-width:768px){.md-grid-two{grid-template-columns:repeat(2,1fr);}}</style>
                            ...
                            <div style="grid-column:1/-1;">
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="name" class="sky-input" value="{{ old('name') }}" required autofocus>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="email" name="email" class="sky-input" value="{{ old('email') }}" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="phone_number" class="sky-input" value="{{ old('phone_number') }}">
                                </div>
                                @error('phone_number')<p class="err">{{ $message }}</p>@enderror
                            </div>

                            {{-- Agama — Custom Searchable Dropdown --}}
                            <div>
                                ...
                                <div class="csd-wrap" data-csd="agama">
                                    ...
                                    <button type="button" class="csd-trigger" data-target="agama" tabindex="0" aria-haspopup="listbox">
                                    ...
                                    <div class="csd-panel" id="csd-panel-agama" role="listbox">
                                        ...
                                        <div class="csd-list" id="csd-list-agama">
                                            ...
                                            @foreach(['Islam','Kristen','Katolik','Hindu','Buddha','Konghucu'] as $r)
                                            <div class="csd-option{{ old('religion')==$r?' selected':'' }}" data-value="{{ $r }}" data-list="agama">{{ $r }}</div>
                                            @endforeach
                                        </div>
                    ...
                    <div class="gc form-anim" style="padding:1.5rem;">
                        ...
                        <div class="grid-responsive-2">
                            ...
                            {{-- Pilih Siswa — Custom Searchable Dropdown --}}
                            <div>
                                ...
                                <div class="csd-wrap" data-csd="student">
                                    <select name="student_id" class="csd-native" id="csd-native-student" required>
                                        ...
                                        <option value="{{ $student->student->id }}" {{ old('student_id')==$student->student->id?'selected':'' }}>
                                    ...
                                    <button type="button" class="csd-trigger" data-target="student" tabindex="0" aria-haspopup="listbox">
                                        <span class="csd-trigger-text placeholder" id="csd-text-student">Pilih Siswa</span>
                                        <svg class="csd-trigger-icon" style="width:14px;height:14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/></svg>
                                    </button>

                                    <div class="csd-panel" id="csd-panel-student" role="listbox">
                                        <div class="csd-search-wrap">
                                            <svg class="csd-search-icon" style="width:13px;height:13px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z"/></svg>
                                        ...
                                        <div class="csd-list" id="csd-list-student">
                                            ...
                                            @foreach($students as $student)
                                            <div class="csd-option{{ old('student_id')==$student->student->id?' selected':'' }}"
                            ...
                            {{-- Hubungan Keluarga — Custom Searchable Dropdown --}}
                            <div>
                                ...
                                <div class="csd-wrap" data-csd="relationship">
                                    ...
                                    <button type="button" class="csd-trigger" data-target="relationship" tabindex="0" aria-haspopup="listbox">
                                        <span class="csd-trigger-text placeholder" id="csd-text-relationship">Pilih Hubungan</span>
                                        <svg class="csd-trigger-icon" style="width:14px;height:14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/></svg>
                                    </button>

                                    <div class="csd-panel" id="csd-panel-relationship" role="listbox">
                                        <div class="csd-search-wrap">
                                            <svg class="csd-search-icon" style="width:13px;height:13px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z"/></svg>
                                        ...
                                        <div class="csd-list" id="csd-list-relationship">
                                            ...
                                            @foreach(['Ayah','Ibu','Wali','Kakak','Nenek','Kakek','Paman','Bibi'] as $rel)
                                            <div class="csd-option{{ old('family_relationship')==$rel?' selected':'' }}" data-value="{{ $rel }}" data-list="relationship">{{ $rel }}</div>
                                            @endforeach
                                        </div>
                        ...
                        {{-- Kode Login --}}
                        <div style="grid-column:1/-1;">
                            <label class="sky-label">Kode Login <span style="color:#10b981;font-weight:500;text-transform:none;letter-spacing:0">(otomatis di-generate)</span></label>
                            <div class="field-wrap" style="display:flex;gap:8px;">
                                ...
                                <input type="text" name="login_code" id="login_code_input" class="sky-input" value="{{ old('login_code') }}" readonly style="flex:1;background:rgba(240,249,255,0.7);font-family:monospace;font-weight:700;font-size:1rem;letter-spacing:.15em;">
                                <button type="button" onclick="generateLoginCode()" class="btn-ghost" style="padding:.55rem .875rem;white-space:nowrap;">
                            ...
                            <p class="hint">Kode ini digunakan orang tua untuk login. Akan otomatis di-generate jika dikosongkan.</p>
                    ...
                    <div class="gc form-anim" style="padding:1.5rem;">
                        ...
                        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;">
                            <div>
                                <label class="sky-label">Password <span style="color:#ef4444">*</span></label>
                                <div class="field-wrap">
                                    ...
                                    <input type="password" name="password" class="sky-input" required>
                                </div>
                            ...
                            <div>
                                <label class="sky-label">Konfirmasi Password <span style="color:#ef4444">*</span></label>
                                <div class="field-wrap">
                                    <span class="field-icon"><svg style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></span>
                                    <input type="password" name="password_confirmation" class="sky-input" required>
                                </div>
                    ...
                    <div class="gc form-anim" style="padding:1.5rem;">
                        ...
                        <div class="toggle-wrap">
                            <input type="checkbox" name="is_active" id="is_active" class="toggle-input" {{ old('is_active',true)?'checked':'' }}>
                            <div>
                ...
                {{-- Tips Card --}}
                <div class="gc form-anim" style="padding:1.25rem 1.5rem;margin-top:1.25rem;">
                    <div style="display:flex;align-items:flex-start;gap:12px;">
                        <div style="width:36px;height:36px;border-radius:10px;background:rgba(56,189,248,0.12);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <svg style="width:18px;height:18px;color:#0ea5e9" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div style="font-size:.82rem;color:#334155;">
                            <p style="font-weight:700;color:#0c4a6e;margin-bottom:6px;">Tips Pengisian:</p>
                            <ul style="list-style:disc;padding-left:1.25rem;margin:0;display:flex;flex-direction:column;gap:4px;">
                                <li>Email harus valid dan belum terdaftar di sistem</li>
                                <li>Password minimal 8 karakter untuk keamanan akun</li>
                                <li>Pilih siswa yang sudah terdaftar di sistem</li>
                                <li>Hubungan keluarga sesuai dengan status orang tua/wali</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                {{-- Actions --}}
                <div style="display:flex;align-items:center;justify-content:flex-end;gap:10px;margin-top:1.25rem;">
                    <a href="{{ route('user-management.parents.index') }}" class="btn-ghost">
    ...
    (function () {
        ...
        // Initialize: restore old() values if any
        ...
        function openDropdown(id) {
            ...
            // Elevate the parent .gc card above siblings
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const input = document.getElementById('login_code_input');
        if (input && !input.value) generateLoginCode();
    });
    </script>
</x-app-layout>
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex flex-wrap gap-2">
                <a href="{{ route('user-management.parents.show', $parent->id) }}" class="btn-amber">
    ...
    <div style="padding:1.5rem 0;">
        <div style="max-width:1600px;margin:0 auto;padding:0 1rem;" class="sm:px-6 lg:px-8 xl:px-12">
            ...
            <form method="POST" action="{{ route('user-management.parents.update', $parent->id) }}">
                @csrf @method('PUT')
            ...
            <div style="margin-top:1.5rem;padding:1.25rem 1.5rem;border-radius:16px;border:1.5px solid rgba(252,165,165,0.4);background:rgba(254,242,242,0.7);">
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
                    ...
                    <form action="{{ route('user-management.parents.destroy', $parent->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data {{ $parent->user->name }}? Data tidak dapat dikembalikan.')">
                        @csrf @method('DELETE')

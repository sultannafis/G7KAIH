<x-app-layout>
    ...
    <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 pb-12">
        ...
        <div class="gc rounded-2xl p-5 mb-6">
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="sm:w-auto flex flex-col gap-2 justify-end">
                    <label class="block text-xs font-600 text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                        &nbsp;
                    </label>
                    <div class="flex gap-2">
                        ...
                        <button type="button" onclick="submitAttendance()"
                                id="btnSubmit"
                                disabled
                                class="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-600 transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        {{-- ── Student Table ───────────────────────────────────── --}}
        <div class="gc rounded-2xl overflow-hidden shadow-sm mb-20">
                ...
                <table class="w-full text-left border-collapse min-w-[700px]">
                    ...
                    <tbody id="studentTableBody" class="divide-y divide-slate-100 dark:divide-slate-800">
                        @foreach($students as $index => $student)
                            ...
                            @endphp
                            <tr class="student-row transition-all duration-200 cursor-pointer hover:bg-slate-50 dark:hover:bg-transparent {{ $submitted ? 'opacity-60 bg-slate-50/50 dark:bg-transparent' : '' }}"
                                ...
                                <td class="px-4 py-3 text-center w-14">
                                ...
                                <td class="px-4 py-3">
                                    @if($applicableRule)
                                        <div class="flex flex-col">
                                            <span class="text-[10px] text-slate-400 uppercase tracking-wide">{{ $applicableRule->name }}</span>
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    @else
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-full text-[10px] font-700 tracking-wide uppercase text-slate-500 bg-slate-100 border border-slate-200 dark:bg-transparent dark:border-slate-700">
                                            Belum
                                        </span>
                                    @endif
                                </td>

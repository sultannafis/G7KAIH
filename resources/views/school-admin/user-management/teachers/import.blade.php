        ...
        <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 space-y-5">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                ...
                <div class="gc card-in rounded-3xl p-5 sm:p-6">
                    ...
                    <a href="{{ route('school-admin.user-management.teachers.download-template') }}" class="btn-emerald">
                ...
                <div class="gc card-in rounded-3xl p-5 sm:p-6">
                    ...
                    <form action="{{ route('school-admin.user-management.teachers.process-import') }}"
                        ...
                        <div class="form-actions">
                            <a href="{{ route('school-admin.user-management.teachers.index') }}" class="btn-ghost">Batal</a>

<x-app-layout>
    ...
    <div class="pb-12">
        <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            ...
            <form method="POST" action="{{ route('school-admin.user-management.students.update', $student->id) }}">
                @csrf @method('PUT')
            ...
            <div style="margin-top:1.5rem;padding:1.25rem 1.5rem;border-radius:16px;border:1.5px solid rgba(252,165,165,0.4);background:rgba(254,242,242,0.7);">
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
                    ...
                    <form action="{{ route('school-admin.user-management.students.destroy', $student->id) }}" method="POST"

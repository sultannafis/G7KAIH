<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            .upload-zone {
                border:2px dashed rgba(125,211,252,.5);border-radius:16px;padding:32px 20px;
                text-align:center;cursor:pointer;transition:all .2s ease;background:rgba(240,249,255,.3);
            }
            .upload-zone:hover,.upload-zone.drag-over { border-color:rgba(56,189,248,.8);background:rgba(224,242,254,.5); }
            .upload-zone input[type=file] { display:none }

            .col-tag {
                display:inline-flex;align-items:center;gap:5px;
                background:rgba(219,234,254,.6);border:1px solid rgba(147,197,253,.5);
                color:#1e40af;padding:3px 10px;border-radius:99px;font-size:.7rem;font-weight:700;white-space:nowrap;
            }
            ...
            @media (min-width:480px) {
                ...
                .form-actions .btn-ghost,.form-actions .btn-primary { width:auto }
            }
        </style>
        ...
        <div class="page-header">
            <div>
                ...
                <h1 class="text-2xl font-bold text-sky-800" style="letter-spacing:-.02em">Import Data Siswa</h1>
                <p class="text-sm text-sky-500 font-medium mt-0.5">Upload file Excel untuk import data massal</p>
            </div>
            <a href="{{ route('school-admin.user-management.students.index') }}" class="btn-ghost" style="align-self:flex-start">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:14px;height:14px;flex-shrink:0"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
                Kembali
            </a>
        </div>
    </x-slot>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                ...
                <div class="gc card-in rounded-3xl p-5 sm:p-6">
                    ...
                    <p style="font-size:.875rem;color:rgba(14,116,144,.65);line-height:1.6;margin-bottom:16px">
                        Unduh template Excel yang sudah tersedia, isi data siswa sesuai format, lalu upload kembali.
                    </p>
                    ...
                    <div style="background:rgba(240,249,255,.5);border:1px solid rgba(186,230,253,.4);border-radius:14px;padding:16px;margin-bottom:20px">
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:6px">
                            <span class="col-tag required">Nama Lengkap *</span>
                            <span class="col-tag required">Email *</span>
                            <span class="col-tag required">Tingkat Kelas *</span>
                            <span class="col-tag required">Nama Kelas *</span>
                            <span class="col-tag required">Password *</span>
                            <span class="col-tag">Nomor Telepon</span>
                            <span class="col-tag">Agama</span>
                            <span class="col-tag">NISN (Opsional)</span>
                            <span class="col-tag">NIS (Opsional)</span>
                            <span class="col-tag">Jurusan</span>
                            <span class="col-tag">Jenis Kelamin</span>
                        </div>
                    ...
                    <a href="{{ route('school-admin.user-management.students.download-template') }}" class="btn-emerald">
                ...
                <div class="gc card-in rounded-3xl p-5 sm:p-6">
                    ...
                    <form method="POST" action="{{ route('school-admin.user-management.students.process-import') }}" enctype="multipart/form-data" class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="upload-zone" id="dropZone" onclick="document.getElementById('fileInput').click()">
                                ...
                                <div id="fileDisplay">
                                    ...
                                    <p style="font-size:.75rem;color:rgba(14,116,144,.5)">.xlsx, .xls, atau .csv — maks. 5 MB</p>
                                </div>
                            </div>
                            ...
                            <div style="display:flex;gap:10px">
                                ...
                                <div>
                                    ...
                                    <ul style="font-size:.78rem;color:#92400e;line-height:1.7;list-style:none;padding:0;margin:0">
                                        ...
                                        <li style="display:flex;align-items:flex-start;gap:6px;margin-bottom:3px">
                                            <svg style="width:12px;height:12px;flex-shrink:0;margin-top:3px" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Tingkat Kelas harus: <strong>X, XI, atau XII</strong>
                                        </li>
                                        <li style="display:flex;align-items:flex-start;gap:6px">
                                            <svg style="width:12px;height:12px;flex-shrink:0;margin-top:3px" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Siswa yang diimport aktif secara default
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('school-admin.user-management.students.index') }}" class="btn-ghost">Batal</a>
            ...
            <div class="gc tbl-in rounded-3xl overflow-hidden">
                ...
                <div style="padding:16px 20px;border-bottom:1px solid rgba(186,230,253,.3);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px">
                    <div style="display:flex;align-items:center;gap:10px">
                        ...
                        <div>
                            ...
                            <p style="font-size:.7rem;color:rgba(14,116,144,.45);margin-top:1px">3 contoh format data siswa</p>
                        </div>
                    </div>
                </div>
                ...
                $previews = [
                    [
                        ...
                        'kelas'     => 'X RPL 1',
                        'tingkat'   => 'X',
                        'email'     => 'andi.prasetyo@siswa.sch.id',
                        'pass'      => 'Password123!',
                        'telp'      => '081234567890',
                        'agama'     => 'Islam',
                        'nisn'      => '0012345678',
                    ...
                    [
                        ...
                        'kelas'     => 'XII TKJ 1',
                        'tingkat'   => 'XII',
                        'email'     => 'rizky.firmansyah@siswa.sch.id',
                        'pass'      => 'Rizky#789',
                        'telp'      => '083456789012',
                        'agama'     => 'Islam',
                        'nisn'      => '0098765432',
                    ...
                    <div style="padding:14px 16px">
                        ...
                        <div style="display:flex;align-items:flex-start;gap:10px;margin-bottom:10px">
                            ...
                            <div>
                                ...
                                <p style="font-size:.7rem;color:rgba(14,116,144,.5);margin-top:1px">{{ $row['kelas'] }} — {{ $row['jk'] }}</p>
                            </div>
                        </div>
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:6px">
                            ...
                            @else
                                <span style="font-size:.68rem;font-weight:600;color:rgba(14,116,144,.3)">NISN —</span>
                            @endif
                            @if($row['nis'])
                            ...
                            @else
                                <span style="font-size:.68rem;font-weight:600;color:rgba(14,116,144,.3)">NIS —</span>
                            @endif
                        </div>
                    </div>
                    @endforeach
                    ...
                    <table style="width:100%;border-collapse:collapse;min-width:900px">
                        <thead>
                            <tr>
                                ...
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">Nama Lengkap <span style="color:#e11d48">*</span></th>
                                ...
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">Tingkat <span style="color:#e11d48">*</span></th>
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">Nama Kelas <span style="color:#e11d48">*</span></th>
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">Telepon</th>
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">NISN</th>
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">NIS</th>
                                <th style="padding:10px 14px;font-size:.65rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:rgba(14,116,144,.6);background:rgba(240,249,255,.7);border-bottom:2px solid rgba(186,230,253,.4);text-align:left;white-space:nowrap">Jenis Kelamin</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($previews as $row)
                            <tr style="{{ $loop->even ? 'background:rgba(240,249,255,.3)' : '' }}">
                                ...
                                <td style="padding:11px 14px;border-bottom:1px solid rgba(186,230,253,.12)">
                                    ...
                                    <div style="font-size:.68rem;color:rgba(14,116,144,.45);margin-top:1px">{{ $row['jurusan'] }} — {{ $row['agama'] }}</div>
                                </td>
                                ...
                                <td style="padding:11px 14px;border-bottom:1px solid rgba(186,230,253,.12)">
                                    <span style="background:rgba(254,249,195,.7);border:1px solid rgba(253,224,71,.4);color:#78350f;padding:2px 10px;border-radius:6px;font-size:.75rem;font-weight:800">{{ $row['tingkat'] }}</span>
                                </td>
                                <td style="padding:11px 14px;color:rgba(14,116,144,.7);font-size:.8rem;border-bottom:1px solid rgba(186,230,253,.12)">{{ $row['kelas'] }}</td>
                                ...
                                <td style="padding:11px 14px;border-bottom:1px solid rgba(186,230,253,.12)">
                                    @if($row['nisn'])
                                        <span style="background:rgba(219,234,254,.7);border:1px solid rgba(147,197,253,.5);color:#1e40af;padding:2px 8px;border-radius:6px;font-size:.72rem;font-weight:700;white-space:nowrap">{{ $row['nisn'] }}</span>
                                    @else
                                ...
                                <td style="padding:11px 14px;border-bottom:1px solid rgba(186,230,253,.12)">
                                    @if($row['nis'])
                                        <span style="background:rgba(209,250,229,.7);border:1px solid rgba(167,243,208,.5);color:#065f46;padding:2px 8px;border-radius:6px;font-size:.72rem;font-weight:700;white-space:nowrap">{{ $row['nis'] }}</span>
                                    @else
                                        <span style="color:rgba(14,116,144,.3);font-weight:600">—</span>
                                    @endif
                                </td>
                                <td style="padding:11px 14px;border-bottom:1px solid rgba(186,230,253,.12)">
                                    @if($row['jk'] === 'Laki-laki')
                                        <span style="background:rgba(219,234,254,.6);border:1px solid rgba(147,197,253,.4);color:#1e40af;padding:2px 10px;border-radius:6px;font-size:.72rem;font-weight:700">{{ $row['jk'] }}</span>
                                    @else
                                        <span style="background:rgba(252,231,243,.6);border:1px solid rgba(249,168,212,.4);color:#9d174d;padding:2px 10px;border-radius:6px;font-size:.72rem;font-weight:700">{{ $row['jk'] }}</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
                ...
                <div style="padding:12px 20px;border-top:1px solid rgba(186,230,253,.2);display:flex;flex-wrap:wrap;gap:12px;align-items:center">
                    ...
                    <div style="display:flex;align-items:center;gap:6px">
                        <span style="background:rgba(254,249,195,.7);border:1px solid rgba(253,224,71,.4);color:#78350f;padding:2px 8px;border-radius:6px;font-size:.7rem;font-weight:800">X / XI / XII</span>
                        <span style="font-size:.72rem;color:rgba(14,116,144,.5)">Tingkat kelas yang valid</span>
                    </div>
                </div>
            </div>

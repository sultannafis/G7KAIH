<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            .csd-trigger-icon { position:absolute;right:.65rem;top:50%;transform:translateY(-50%);pointer-events:none;color:#38bdf8;transition:transform .2s;flex-shrink:0; }
            ...
            .gender-option label {
                ...
                padding:.6rem 1rem;border-radius:10px;border:1.5px solid rgba(186,230,253,0.8);
                background:rgba(255,255,255,0.9);font-size:.82rem;font-weight:600;color:#64748b;
                cursor:pointer;transition:all .18s;width:100%;box-sizing:border-box;
            }
            .gender-option input[type=radio]:checked + label {
                border-color:#38bdf8;background:rgba(224,242,254,0.7);color:#0369a1;
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <h2 class="text-2xl font-bold text-sky-800" style="letter-spacing:-.02em">Tambah Siswa Baru</h2>
                <p class="text-sm text-sky-500 font-medium mt-0.5">Tambah data siswa baru ke sistem</p>
            </div>
            <div>
                <a href="{{ route('school-admin.user-management.students.index') }}" class="btn-ghost">
    ...
    <div class="pb-12">
        <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            ...
            @endif
            <form method="POST" action="{{ route('school-admin.user-management.students.store') }}">
                @csrf
                    ...
                    <div class="gc form-anim" style="padding:1.5rem;">
                        <div class="section-title">
                            <div class="section-icon">
                                <svg style="width:15px;height:15px;color:#fff" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </div>
                            Informasi Akun
                        </div>

                        <div class="grid-responsive-2" style="margin-bottom:1rem;">
                            {{-- Nama Lengkap --}}
                            <div style="grid-column:1/-1;">
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="name" class="sky-input" value="{{ old('name') }}" required autofocus placeholder="Nama lengkap siswa">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="email" name="email" class="sky-input" value="{{ old('email') }}" required placeholder="email@sekolah.com">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="phone_number" class="sky-input" value="{{ old('phone_number') }}" placeholder="08xxxxxxxxxx">
                                </div>
                            ...
                            <div style="grid-column:1/-1;">
                                ...
                                <div class="gender-options">
                                    <div class="gender-option">
                                        <input type="radio" name="gender" id="gender_laki" value="Laki-laki" {{ old('gender')=='Laki-laki' ? 'checked' : '' }}>
                                    ...
                                    <div class="gender-option">
                                        <input type="radio" name="gender" id="gender_perempuan" value="Perempuan" {{ old('gender')=='Perempuan' ? 'checked' : '' }}>
                        ...
                        <div class="grid-responsive-3" style="margin-bottom:1rem;">
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="nisn" class="sky-input" value="{{ old('nisn') }}" placeholder="Nomor Induk Siswa Nasional">
                                </div>
                                <p class="hint">Kosongkan jika belum ada</p>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="nis" class="sky-input" value="{{ old('nis') }}" placeholder="Nomor Induk Siswa Lokal">
                                </div>
                                <p class="hint">Nomor induk di sekolah ini</p>
                            ...
                            <div>
                                ...
                                <div class="csd-wrap" data-csd="grade">
                                    <select name="grade_level" class="csd-native" id="csd-native-grade" required>
                                        ...
                                        <option value="{{ $g }}" {{ old('grade_level')==$g?'selected':'' }}>Kelas {{ $g }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="csd-panel" id="csd-panel-grade">
                                        <div class="csd-list" id="csd-list-grade">
                                            ...
                                            @foreach(['X','XI','XII'] as $g)
                                            <div class="csd-option{{ old('grade_level')==$g?' selected':'' }}" data-value="{{ $g }}" data-list="grade">Kelas {{ $g }}</div>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="class_name" class="sky-input" value="{{ old('class_name') }}" required placeholder="cth: RPL 1, IPA 2">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <input type="text" name="major" class="sky-input" value="{{ old('major') }}" placeholder="cth: RPL, TKJ, IPA">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="csd-wrap" data-csd="g7class">
                                    <select name="g7_kaih_class_id" class="csd-native" id="csd-native-g7class">
                                        ...
                                        <option value="{{ $cls->id }}" {{ old('g7_kaih_class_id')==$cls->id?'selected':'' }}>{{ $cls->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="csd-panel" id="csd-panel-g7class">
                                        ...
                                        <div class="csd-list" id="csd-list-g7class">
                                            ...
                                            @foreach($classes as $cls)
                                            <div class="csd-option{{ old('g7_kaih_class_id')==$cls->id?' selected':'' }}" data-value="{{ $cls->id }}" data-list="g7class">{{ $cls->name }}</div>
                                            @endforeach
                                        </div>

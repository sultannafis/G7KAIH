    ...
    <x-slot name="header">
        ...
        <div class="flex items-center justify-between header-in">
            <div>
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-sky-800" style="letter-spacing:-.02em">Tambah Kelas Baru</h1>
                <p class="text-sky-500 font-medium mt-1 text-sm">Isi form di bawah untuk menambahkan kelas baru</p>
            </div>
        ...
        <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            <div class="w-full">
                ...
                <div class="gc form-in rounded-3xl p-6 sm:p-8">
                    <form method="POST" action="{{ route('school-admin.classes.store') }}" class="space-y-5">
                        @csrf

<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <p class="text-xs font-bold uppercase tracking-[.15em] text-sky-500 mb-1">Pengaturan Sekolah</p>
                <h1 class="text-2xl sm:text-3xl font-bold text-sky-800" style="letter-spacing:-.02em">Profil Sekolah</h1>
    ...
    <div class="pb-10">
        <div class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            ...
            <form action="{{ route('school-admin.settings.update') }}" method="POST" enctype="multipart/form-data" id="schoolForm">
                @csrf @method('PUT')
                        ...
                        <div class="gc fade-in rounded-3xl p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="city_id" name="city_id" class="sky- ">

...
<head>
    ...
    <title>Lupa Password - G7KAIH</title>
...
<body>
    ...
    <div class="login-card">
        <div class="brand-section">
            ...
            <h1 class="brand-name">Lupa Password</h1>
            <p class="brand-tagline">Masukkan alamat email Anda yang terdaftar. Kami akan mengirimkan tautan untuk mereset password melalui Email atau pesan instan.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="form-control" placeholder="nama@sekolah.sch.id" value="{{ old('email') }}" required autofocus>
            </div>

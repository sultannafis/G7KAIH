...
class TeacherController extends Controller
{
    ...
    /**
     * Generate template Excel - PERBAIKAN UTAMA
     */
    private function generateTemplate()
    {
        try {
            ...
            // PENTING: Header kolom - gunakan nama PERSIS seperti di TeachersImport
            $headers = [
                'A10' => 'Nama Lengkap*',
                'B10' => 'Email*',
                'C10' => 'Nomor Telepon*',
            ...
            foreach ($examples as $example) {
                ...
                foreach ($example as $value) {
                    ...
                    // Untuk kolom phone, NIP, dan NIK, set sebagai text explicitly
    ...
    public function index(Request $request)
    {
        ...
        return view('school-admin.user-management.teachers.index', compact('teachers', 'search', 'status', 'perPage'));
    }
    ...
    public function create()
    {
        ...
        return view('school-admin.user-management.teachers.create', compact('school'));
    }
    ...
    public function store(StoreTeacherRequest $request)
    {
        ...
        try {
            ...
            try {
                ...
                \Illuminate\Support\Facades\Log::error('Gagal mengirim notifikasi AccountCreated (Guru): ' . $e->getMessage());
            }

            return redirect()->route('school-admin.user-management.teachers.index')
    ...
    {
        // Pastikan teacher ini milik sekolah yang sama dengan user yang login
        $school = Auth::user()->school;
        ...
        return view('school-admin.user-management.teachers.show', compact('teacher'));
    }
    ...
    public function edit(Teacher $teacher)
    {
        ...
        return view('school-admin.user-management.teachers.edit', compact('teacher'));
    }
    ...
    public function destroy(Teacher $teacher)
    {
        ...
        try {
            ...
            // Hapus user (akan otomatis hapus teacher karena cascade)
            $teacher->user->delete();
    ...
    {
        return view('school-admin.user-management.teachers.import');
    }

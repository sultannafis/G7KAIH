...
return [
    ...
    */
    ...
    'digits_between'       => ':attribute harus berisikan antara :min sampai :max angka.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Baris-baris Bahasa untuk Validasi Custom
    |--------------------------------------------------------------------------
    |
    ...
    | mempercepat kita dalam menentukan baris bahasa khusus untuk aturan atribut yang diberikan.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut digunakan untuk menukar pplace-holder atribut kita
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'Kata Sandi',
        'name' => 'Nama',
        'student_code' => 'NIS/NISN',
        'login_code' => 'Kode Login',
    ],
